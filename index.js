...
console.log(createMenuItem('noddles',3,'lunch'));
...
*/
reviews.push({name:"Selina", rating:4.5, feedback:"service is food and food is great."})
console.log(reviews);
...
function getReviewByIndex(array, indexNum) {
  let string=`${array[indexNum].name} gave the restaurant a ${array[indexNum].rating} star review, and their feedback was: ${array[indexNum].feedback}`
  return string;
}
...
function getLastReview(array) {
  let lastReview=`${array[array.length-1].name} gave the restaurant a ${array[array.length-1].rating} star review, and their feedback was: ${array[array.length-1].feedback}`;
  return lastReview;
} 
...
*/
 ...
 function getReviewByRating(array, rating) {
  ...
  for(let i=0; i< array.length; i++){
    ...
    if(array[i].rating<max && array[i].rating>=rating){
...
// const car1{
//   drive: function(distance){
//     let updatedOdometer= odometer+distance;
